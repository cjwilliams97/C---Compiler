...
scopedVarDecl       : STATIC typeSpec varDeclList ';' {$$ = setNodeType($2, $3, true);}
                    | typeSpec varDeclList ';' {$$ = setNodeType($1, $2, false);} 
                    ;
...
parmTypeList        : typeSpec parmIdList {$$ = setNodeType($1, $2, false);}
                    ;
