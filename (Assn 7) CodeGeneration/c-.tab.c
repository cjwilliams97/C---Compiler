...
static const yytype_int16 yyrline[] =
{
      ...
      65,    68,    69,    72,    73,    74,    75,    78,    79,    80,
      81,    84,    85,    86,    87,    90,    91,    92,    95,    96,
      97,    98,    99,   100,   101,   104,   105,   108,   109,   110,
     111,   114,   115,   118,   119,   120,   121,   124,   125,   128,
     131,   132,   133,   136,   139,   140,   143,   144,   145,   146,
     149,   150,   153,   154,   157,   158,   159,   160,   161,   162,
     163,   164,   165,   166,   167,   170,   171,   172,   173,   174,
     175,   176,   179,   180,   181,   182,   183,   186,   187,   188,
     191,   194,   195,   196,   197,   198,   199,   200,   201,   202,
     203,   204,   205,   206,   207,   208,   209,   210,   211,   212,
     213,   216,   217,   218,   221,   222,   223,   226,   227,   228,
     231,   232,   233,   236,   237,   238,   239,   240,   241,   244,
     245,   248,   249,   252,   253,   254,   257,   258,   261,   262,
     263,   266,   267,   268,   271,   272,   273,   276,   277,   278,
     281,   282,   285,   286,   289,   290,   291,   292,   295,   296,
     299,   300,   303,   304,   305,   308,   309,   310,   311
};
#endif
...
#line 1795 "c-.tab.c"
  ...
  case 22:
#line 85 "c-.y"
                                          {(yyval.treeNode) = newDeclNode(VarDeclK, Void, (yyvsp[-3].tokenData), NULL, NULL, NULL, true); (yyval.treeNode)->size = (yyvsp[-1].tokenData)->numValue + 1;}
#line 1801 "c-.tab.c"
    break;
...
#line 2047 "c-.tab.c"
  ...
  case 64:
#line 157 "c-.y"
                                                             {(yyval.treeNode) = newStmtNode(IfK, (yyvsp[-5].tokenData), NULL, (yyvsp[-4].treeNode), (yyvsp[-2].treeNode), (yyvsp[0].treeNode)); (yyval.treeNode)->hasMatchingElse = true;}
#line 2053 "c-.tab.c"
    break;
...
#line 2149 "c-.tab.c"
  ...
  case 81:
#line 176 "c-.y"
                                                              { (yyval.treeNode) = NULL; yyerrok; (yyval.treeNode)->hasMatchingElse = true;}
#line 2155 "c-.tab.c"
    break;
...
#line 2209 "c-.tab.c"
  ...
  case 91:
#line 194 "c-.y"
                                      {(yyval.treeNode) = newExpNode(AssignK, (yyvsp[-1].tokenData), (yyvsp[-2].treeNode), (yyvsp[0].treeNode), NULL); (yyvsp[-2].treeNode)->isLhsInExp = true;}
#line 2215 "c-.tab.c"
    break;
...
#line 2239 "c-.tab.c"
  ...
  case 96:
#line 199 "c-.y"
                                  {(yyval.treeNode) = newExpNode(AssignK, (yyvsp[0].tokenData), (yyvsp[-1].treeNode), NULL, NULL); (yyvsp[-1].treeNode)->isLhsInExp = true;}
#line 2245 "c-.tab.c"
    break;
...
#line 2329 "c-.tab.c"
  ...
  case 111:
#line 216 "c-.y"
                                          {(yyval.treeNode) = newExpNode(OpK, (yyvsp[-1].tokenData), (yyvsp[-2].treeNode), (yyvsp[0].treeNode), NULL); (yyvsp[-2].treeNode)->isLhsInExp = true;}
#line 2335 "c-.tab.c"
    break;
...
#line 2581 "c-.tab.c"
  ...
  case 153:
#line 286 "c-.y"
                                     {(yyval.treeNode) = newExpNode(IdArrK, (yyvsp[-2].tokenData), newExpNode(IdK, (yyvsp[-3].tokenData), NULL, NULL, NULL), (yyvsp[-1].treeNode), NULL); (yyval.treeNode)->child[0]->isIndexed = true;}
#line 2587 "c-.tab.c"
    break;
...
#line 2635 "c-.tab.c"
  ...
  case 162:
#line 303 "c-.y"
                                      {(yyval.treeNode) = setSibling((yyvsp[-2].treeNode), (yyvsp[0].treeNode)); (yyvsp[0].treeNode)->isCallArg = true; yyerrok;}
#line 2641 "c-.tab.c"
    break;

  case 163:
#line 304 "c-.y"
                          {(yyval.treeNode) = (yyvsp[0].treeNode); (yyval.treeNode)->isCallArg = true;}
#line 2647 "c-.tab.c"
    break;
