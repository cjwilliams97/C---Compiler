...
* THEN
* EXPRESSION
 68:    LDA  3,-2(1)	Load variable (address) x
 69:     ST  3,-3(1)	Push left side (store variable address in frame) 
* TOFF dec: -4
* EXPRESSION
 70:    LDA  3,-2(1)	Load variable (address) x
 71:     ST  3,-4(1)	Push left side (store variable address in frame) 
* TOFF dec: -5
...
* TOFF inc: -3
 ...
 67:    JZR  3,12(7)	Jump around the THEN if false [backpatch] 
* ELSE
* BREAK
 80:    JMP  7,-28(7)	break 
 79:    JMP  7,1(7)	Jump around the ELSE [backpatch] 
* TOFF set: -3
* END COMPOUND
