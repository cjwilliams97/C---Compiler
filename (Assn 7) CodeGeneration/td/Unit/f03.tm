...
* Compound Body
* CALL cat
 46:     ST  1,-2(1)	Store fp in ghost frame for outputs 
* TOFF dec: -3
* TOFF dec: -4
* CALL output
 47:     ST  1,-4(1)	Store fp in ghost frame for outputs 
* TOFF dec: -5
* TOFF dec: -6
* Param 1
* END COMPOUND
...
* INIT
 ...
 53:     ST  1,0(0)	store old fp (point to self) 
* INIT GLOBALS AND STATICS
* END INIT GLOBALS AND STATICS
 54:    LDA  3,1(7)	Return address in ac 
 55:    JMP  7,-11(7)	Jump to main 
 56:   HALT  0,0,0	DONE! 
* END INIT
